...
function doRectanglesOverlap(rect1, rect2) {
  ...
  if (top2 >= top1 && top2 <= bottom1 && right2 >= left1 && right2 <= right1) {
    return true;
  }
  if (bottom2 >= top1 && bottom2 <= bottom1 && left2 >= left1 && left2 <= right1) {
    return true;
  }
  if (bottom2 >= top1 && bottom2 <= bottom1 && right2 >= left1 && right2 <= right1) {
    return true;
  }


  if (top1 >= top2 && top1 <= bottom2 && left1 >= left2 && left1 <= right2) {
    return true;
  }
  if (top1 >= top2 && top1 <= bottom2 && right1 >= left2 && right1 <= right2) {
    return true;
  }
  if (bottom1 >= top2 && bottom1 <= bottom2 && left1 >= left2 && left1 <= right2) {
    return true;
  }
  if (bottom1 >= top2 && bottom1 <= bottom2 && right1 >= left2 && right1 <= right2) {
    return true;
  }
...
function isInsideCircle(circle, point) {
  const distance2 = ((point.x - circle.center.x) ** 2) + ((point.y - circle.center.y) ** 2);
...
function reverseInteger(num) {
  const str = reverseString(String(num));
  return Number(str);
}
